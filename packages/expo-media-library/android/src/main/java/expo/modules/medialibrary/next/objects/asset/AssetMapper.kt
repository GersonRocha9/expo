...
class AssetMapper(private val contentResolver: ContentResolver) {
  ...
  private fun toMetadata(imageAsset: MediaStoreImageAsset): AssetMetadata =
    AssetMetadata(
  ...
  private fun toMetadata(videoAsset: MediaStoreVideoAsset): AssetMetadata =
    AssetMetadata(
  ...
  private fun toMetadata(audioAsset: MediaStoreAudioAsset): AssetMetadata =
    AssetMetadata(
